"""
scripts/update_data.py  —  v14 (KBA für Deutschland vorbereitet)
==============================
- ECB für alle Länder bis 2022
- Eurostat jährlich für alle
- Platzhalter für KBA monatliche Daten für Deutschland (ab v15 aktiv)
"""
...
def main():
    ...
    print(f"\n\u2713 Fertig — Monatsdaten enden bei Dezember 2022 (KBA für DE kommt in v15)")
