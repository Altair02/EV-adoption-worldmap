"""
scripts/update_data.py  —  v13 (ACEA PDF — stabil)
==============================
Lädt die neueste ACEA PDF und parst die monatlichen Zulassungen.
"""
...
def main():
    ...
    print("Die Daten werden in v14 in die JSON-Dateien geschrieben.")
